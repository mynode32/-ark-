(function(){"use strict";class A{constructor(t,e){this.canvas=t,this.ctx=t.getContext("2d"),this.config=e,this.segments=e.segments||[],this.theme=e.theme||{},this.style=this.theme.wheelStyle||"premium",this.rotation=0,this.isSpinning=!1,this.audioCtx=null,this.winnerGlow=0,this._idleWobbleFrame=null,this._setupCanvas(),this.render(),this._startIdleWobble()}_startIdleWobble(){this._stopIdleWobble();const t=4*Math.PI/180,e=3200,a=this.rotation,r=performance.now(),i=n=>{if(!this.canvas.isConnected){this._idleWobbleFrame=null;return}const s=(n-r)%e/e;this.rotation=a+t*Math.sin(2*Math.PI*s),this.render(),this._idleWobbleFrame=requestAnimationFrame(i)};this._idleWobbleFrame=requestAnimationFrame(i)}_stopIdleWobble(){this._idleWobbleFrame&&(cancelAnimationFrame(this._idleWobbleFrame),this._idleWobbleFrame=null)}_setupCanvas(){const t=window.devicePixelRatio||1,e=this.theme.wheelSize||330,a=e;this.canvas.width=e*t,this.canvas.height=a*t,this.canvas.style.width=e+"px",this.canvas.style.height=a+"px",this.ctx.setTransform(t,0,0,t,0,0),this.centerX=e/2,this.centerY=a/2,this.radius=Math.min(this.centerX,this.centerY)-12}updateConfig(t){this.config=t,this.segments=t.segments||[],this.theme=t.theme||{},this.style=this.theme.wheelStyle||"premium",this._setupCanvas(),this.render()}render(){const t=this.ctx,e=this.centerX,a=this.centerY,r=this.radius;if(t.clearRect(0,0,this.canvas.width,this.canvas.height),this.segments.length===0)return;const i=2*Math.PI/this.segments.length;let n=this.rotation-Math.PI/2;const[s,c,d]=this._hexToRgb(this.theme.primaryColor||"#FF1E1E");t.shadowColor="rgba(0,0,0,0.5)",t.shadowBlur=15,t.beginPath(),t.arc(e,a,r,0,Math.PI*2),t.fill(),t.shadowBlur=0,this._drawOuterRing(t,e,a,r);for(let l=0;l<this.segments.length;l++){const p=this.segments[l],h=n+i;t.beginPath(),t.moveTo(e,a),t.arc(e,a,r-16,n,h),t.closePath();const g=n+i/2;if(this.style==="standard")t.fillStyle=p.color,t.fill(),t.beginPath(),t.moveTo(e,a),t.lineTo(e+Math.cos(n)*(r-16),a+Math.sin(n)*(r-16)),t.strokeStyle="rgba(255,255,255,0.9)",t.lineWidth=2,t.stroke();else{const tt=e+Math.cos(g)*r,et=a+Math.sin(g)*r,x=t.createLinearGradient(e,a,tt,et);x.addColorStop(0,this._lightenColor(p.color,35)),x.addColorStop(.45,p.color),x.addColorStop(1,this._darkenColor(p.color,30)),t.fillStyle=x,t.fill(),t.strokeStyle=`rgba(${s},${c},${d},0.15)`,t.lineWidth=2,t.stroke(),t.beginPath(),t.moveTo(e,a),t.lineTo(e+Math.cos(n)*(r-16),a+Math.sin(n)*(r-16)),t.strokeStyle=`rgba(${s},${c},${d},0.5)`,t.lineWidth=2,t.stroke()}t.save(),t.translate(e,a),t.rotate(g),t.textAlign="center",t.textBaseline="middle",t.font="22px sans-serif",t.fillText(p.icon||"",r*.35,0);const k=p.label||"",f=r*.65,F=Math.max(20,2*(r-8-f));let y=16;t.font=`800 ${y}px 'Outfit', sans-serif`;let u=k,P=t.measureText(u).width;for(;P>F&&y>8;)y-=1,t.font=`800 ${y}px 'Outfit', sans-serif`,P=t.measureText(u).width;if(P>F){for(;u.length>3&&t.measureText(u+"…").width>F;)u=u.slice(0,-1);u+="…"}t.fillStyle=p.textColor||"#FFFFFF",this.style!=="standard"&&(t.shadowColor="rgba(0,0,0,0.8)",t.shadowBlur=4,t.shadowOffsetX=1,t.shadowOffsetY=1),t.fillText(u,f,0),t.restore(),n=h}if(this.style!=="standard"){t.beginPath(),t.arc(e,a,r-16,0,Math.PI*2);const l=t.createLinearGradient(e-r,a-r,e+r,a+r);l.addColorStop(0,"rgba(255,255,255,0.4)"),l.addColorStop(.4,"rgba(255,255,255,0.05)"),l.addColorStop(.5,"rgba(255,255,255,0)"),l.addColorStop(1,"rgba(0,0,0,0.3)"),t.fillStyle=l,t.fill()}this._drawCenter(t,e,a),this.winnerGlow>0&&this._drawWinnerGlow(t,e,a,r,this.winnerGlow)}_drawWinnerGlow(t,e,a,r,i){const n=-Math.PI/2,s=e+Math.cos(n)*r*.7,c=a+Math.sin(n)*r*.7,[d,l,p]=this._hexToRgb(this.theme.primaryColor||"#FF1E1E");t.save(),t.globalAlpha=Math.max(0,Math.min(1,i));const h=t.createRadialGradient(s,c,0,e,a,r*1.05);h.addColorStop(0,"rgba(255,255,255,0.85)"),h.addColorStop(.25,`rgba(${d},${l},${p},0.5)`),h.addColorStop(1,`rgba(${d},${l},${p},0)`),t.fillStyle=h,t.beginPath(),t.arc(e,a,r,0,Math.PI*2),t.fill(),t.strokeStyle=`rgba(${d},${l},${p},${.6*i})`,t.lineWidth=3,t.beginPath(),t.arc(e,a,r*(.7+.3*i),0,Math.PI*2),t.stroke(),t.restore()}_drawOuterRing(t,e,a,r){const i=this.theme.primaryColor||"#FF1E1E";if(this.style==="standard"){this._drawOuterRingStandard(t,e,a,r,i);return}t.beginPath(),t.arc(e,a,r,0,Math.PI*2);const n=t.createLinearGradient(e-r,a-r,e+r,a+r);if(n.addColorStop(0,this._darkenColor(i,45)),n.addColorStop(.3,i),n.addColorStop(.5,this._lightenColor(i,55)),n.addColorStop(.7,i),n.addColorStop(1,this._darkenColor(i,75)),t.fillStyle=n,t.fill(),t.beginPath(),t.arc(e,a,r-8,0,Math.PI*2),t.fillStyle="#111",t.fill(),this.segments.length>0){const s=2*Math.PI/this.segments.length;let c=this.rotation-Math.PI/2;for(let d=0;d<this.segments.length;d++){const l=e+Math.cos(c)*(r-12),p=a+Math.sin(c)*(r-12);t.beginPath(),t.arc(l,p,3,0,Math.PI*2),t.fillStyle="#FFFFFF",t.shadowColor=i,t.shadowBlur=10,t.fill(),t.shadowBlur=0,c+=s}}}_drawOuterRingStandard(t,e,a,r,i){if(t.beginPath(),t.arc(e,a,r,0,Math.PI*2),t.fillStyle="#F5F5F0",t.fill(),t.beginPath(),t.arc(e,a,r-16,0,Math.PI*2),t.strokeStyle=i,t.lineWidth=1.5,t.stroke(),this.segments.length>0){const n=this.segments.length*4,s=2*Math.PI/n;let c=this.rotation-Math.PI/2;for(let d=0;d<n;d++){const l=e+Math.cos(c)*(r-8),p=a+Math.sin(c)*(r-8);t.beginPath(),t.arc(l,p,2.5,0,Math.PI*2),t.fillStyle="#1a1a1a",t.fill(),c+=s}}}_drawCenter(t,e,a){var k;const r=this.theme.primaryColor||"#FF1E1E",i=this.radius*.18;if(this.style==="standard"){this._drawCenterStandard(t,e,a,i,r);return}const[n,s,c]=this._hexToRgb(r);t.save();const d=t.createRadialGradient(e,a,i*.7,e,a,i*1.6);d.addColorStop(0,`rgba(${n},${s},${c},0.35)`),d.addColorStop(1,`rgba(${n},${s},${c},0)`),t.fillStyle=d,t.beginPath(),t.arc(e,a,i*1.6,0,Math.PI*2),t.fill(),t.restore(),this.theme.pointerStyle==="center"&&this._drawCenterPointerPetal(t,e,a,i),t.beginPath(),t.arc(e,a,i,0,Math.PI*2),t.shadowColor="rgba(0,0,0,0.6)",t.shadowBlur=10,t.shadowOffsetY=4,t.fill(),t.shadowBlur=0,t.shadowOffsetY=0;const l=t.createRadialGradient(e-6,a-6,0,e,a,i);l.addColorStop(0,"#5a5a5e"),l.addColorStop(.55,"#2c2c2e"),l.addColorStop(1,"#0a0a0a"),t.beginPath(),t.arc(e,a,i,0,Math.PI*2),t.fillStyle=l,t.fill(),t.strokeStyle=r,t.lineWidth=4,t.stroke(),t.strokeStyle="rgba(255,255,255,0.2)",t.lineWidth=1,t.beginPath(),t.arc(e,a,i-2,0,Math.PI*2),t.stroke();const p=((k=this.config.settings)==null?void 0:k.storeName)||"Mağaza",h=p.length>8?10:13;t.font=`800 ${h}px 'Outfit', sans-serif`;const g=t.createLinearGradient(e,a-10,e,a+10);g.addColorStop(0,this._lightenColor(r,50)),g.addColorStop(1,r),t.fillStyle=g,t.textAlign="center",t.textBaseline="middle",t.fillText(p,e,a)}_drawCenterStandard(t,e,a,r,i){var c;this.theme.pointerStyle==="center"&&this._drawCenterPointerPetal(t,e,a,r),t.beginPath(),t.arc(e,a,r,0,Math.PI*2),t.shadowColor="rgba(0,0,0,0.25)",t.shadowBlur=6,t.shadowOffsetY=2,t.fillStyle="#FFFFFF",t.fill(),t.shadowBlur=0,t.shadowOffsetY=0,t.strokeStyle=i,t.lineWidth=2,t.stroke();const n=((c=this.config.settings)==null?void 0:c.storeName)||"Mağaza",s=n.length>8?9:12;t.font=`800 ${s}px 'Outfit', sans-serif`,t.fillStyle="#1a1a1a",t.textAlign="center",t.textBaseline="middle",t.fillText(n.toUpperCase(),e,a)}_drawCenterPointerPetal(t,e,a,r){const i=this.theme.pointerColor||"#FF4757",n=r*.55,s=r*.7,c=a-r+8,d=c-s;t.save(),t.shadowColor="rgba(0,0,0,0.35)",t.shadowBlur=4,t.shadowOffsetY=2,t.beginPath(),t.moveTo(e,d),t.quadraticCurveTo(e+n,c-s*.45,e,c),t.quadraticCurveTo(e-n,c-s*.45,e,d),t.closePath(),t.fillStyle=i,t.fill(),t.restore()}_lightenColor(t,e){const a=parseInt(t.replace("#",""),16),r=Math.min(255,(a>>16)+e),i=Math.min(255,(a>>8&255)+e),n=Math.min(255,(a&255)+e);return`rgb(${r},${i},${n})`}_hexToRgb(t){const e=parseInt(t.replace("#",""),16);return[e>>16&255,e>>8&255,e&255]}_darkenColor(t,e){const a=parseInt(t.replace("#",""),16),r=Math.max(0,(a>>16)-e),i=Math.max(0,(a>>8&255)-e),n=Math.max(0,(a&255)-e);return`rgb(${r},${i},${n})`}_setPointerSpinning(t){const e=document.querySelector(".cark-pointer");e&&(e.style.animationPlayState=t?"paused":"running")}_ensureAudio(){this.audioCtx||(this.audioCtx=new(window.AudioContext||window.webkitAudioContext)),this.audioCtx.state==="suspended"&&this.audioCtx.resume()}_playTick(t=0){const e=document.querySelector(".cark-pointer");e&&(e.classList.remove("flick"),e.offsetWidth,e.classList.add("flick"),setTimeout(()=>e.classList.remove("flick"),90));try{this._ensureAudio();const a=this.audioCtx.createOscillator(),r=this.audioCtx.createGain();a.connect(r),r.connect(this.audioCtx.destination);const i=750+t*400;a.type="triangle",a.frequency.setValueAtTime(i,this.audioCtx.currentTime),a.frequency.exponentialRampToValueAtTime(i*.4,this.audioCtx.currentTime+.05);const n=.28+t*.15+Math.random()*.1;r.gain.setValueAtTime(n,this.audioCtx.currentTime),r.gain.exponentialRampToValueAtTime(.01,this.audioCtx.currentTime+.05),a.start(this.audioCtx.currentTime),a.stop(this.audioCtx.currentTime+.05)}catch{}}_playWhoosh(){try{this._ensureAudio();const t=this.audioCtx,e=t.createOscillator(),a=t.createGain();e.connect(a),a.connect(t.destination),e.type="sawtooth",e.frequency.setValueAtTime(110,t.currentTime),e.frequency.exponentialRampToValueAtTime(480,t.currentTime+.25),a.gain.setValueAtTime(.001,t.currentTime),a.gain.exponentialRampToValueAtTime(.12,t.currentTime+.06),a.gain.exponentialRampToValueAtTime(.001,t.currentTime+.25),e.start(t.currentTime),e.stop(t.currentTime+.26)}catch{}}_playLandingThud(){try{this._ensureAudio();const t=this.audioCtx,e=t.createOscillator(),a=t.createGain();e.connect(a),a.connect(t.destination),e.type="sine",e.frequency.setValueAtTime(180,t.currentTime),e.frequency.exponentialRampToValueAtTime(55,t.currentTime+.2),a.gain.setValueAtTime(.35,t.currentTime),a.gain.exponentialRampToValueAtTime(.001,t.currentTime+.3),e.start(t.currentTime),e.stop(t.currentTime+.3)}catch{}}_playWinChime(){try{this._ensureAudio();const t=this.audioCtx;[523.25,659.25,783.99].forEach((a,r)=>{const i=t.createOscillator(),n=t.createGain();i.connect(n),n.connect(t.destination),i.type="triangle";const s=t.currentTime+r*.09;i.frequency.setValueAtTime(a,s),n.gain.setValueAtTime(1e-4,s),n.gain.exponentialRampToValueAtTime(.22,s+.02),n.gain.exponentialRampToValueAtTime(1e-4,s+.35),i.start(s),i.stop(s+.36)})}catch{}}spin(t=null){if(this.isSpinning)return Promise.reject(new Error("Zaten dönüyor"));this._stopIdleWobble(),this.isSpinning=!0,this.winnerGlow=0,this._setPointerSpinning(!0);const e=this.canvas.parentElement;e&&e.classList.add("cark-spinning");const a=t||this._pickWinner();let r=-1;t&&(r=this.segments.findIndex(l=>String(l.id)===String(t.id)),r===-1&&(r=this.segments.findIndex(l=>l.label===t.label)),r===-1&&(r=this.segments.findIndex(l=>l.discountType===t.discountType&&l.discountValue===t.discountValue))),r===-1&&(r=this.segments.indexOf(a)),r===-1&&(console.warn("[Çark] Kazanan dilim eşleşmedi, rastgele bir dilimde durulacak:",t),r=Math.floor(Math.random()*this.segments.length));const i=2*Math.PI/this.segments.length;let n=r*i+i/2;n+=(Math.random()-.5)*i*.6;const c=(8+Math.floor(Math.random()*3))*2*Math.PI+(2*Math.PI-n),d=.12;return this._animateAnticipation(d).then(()=>this._animateMainSpin(c+d)).then(()=>this._animateSettle()).then(()=>this._animateWinnerGlow()).then(()=>(this.isSpinning=!1,this._setPointerSpinning(!1),e&&e.classList.remove("cark-spinning"),this._startIdleWobble(),a))}_animateAnticipation(t){return new Promise(e=>{const a=this.rotation||0,r=260,i=performance.now();this._playWhoosh();const n=s=>{const c=s-i,d=Math.min(c/r,1),l=1-Math.pow(1-d,3);this.rotation=a-t*l,this.render(),d<1?requestAnimationFrame(n):e()};requestAnimationFrame(n)})}_animateMainSpin(t){return new Promise(e=>{const a=this.rotation,i=Math.max(1500,this.theme.spinDurationMs||7e3)+(Math.random()*500-250),n=performance.now();let s=-1;const c=2*Math.PI/Math.max(1,this.segments.length),d=l=>{const p=l-n,h=Math.min(p/i,1),g=1-Math.pow(1-h,5);this.rotation=a+t*g;const k=(Math.PI*2-this.rotation%(Math.PI*2))%(Math.PI*2),f=this.segments.length>0?Math.floor(k/c):-1;f!==s&&s!==-1&&this.segments.length>0&&this._playTick(h),s=f,this.render(),h<1?requestAnimationFrame(d):e()};requestAnimationFrame(d)})}_animateSettle(){return new Promise(t=>{const e=this.rotation,a=450,r=performance.now();this._playLandingThud();const i=n=>{const s=n-r,c=Math.min(s/a,1),d=Math.exp(-6*c),l=Math.sin(c*Math.PI*3)*d*.035;this.rotation=e+l,this.render(),c<1?requestAnimationFrame(i):(this.rotation=e,this.render(),t())};requestAnimationFrame(i)})}_animateWinnerGlow(){return new Promise(t=>{const e=this.canvas.parentElement;e&&e.classList.add("cark-winner-pulse");const a=900,r=performance.now();this._playWinChime();const i=n=>{const s=n-r,c=Math.min(s/a,1);this.winnerGlow=Math.max(0,Math.sin(c*Math.PI*2))*(1-c*.3),this.render(),c<1?requestAnimationFrame(i):(this.winnerGlow=0,this.render(),e&&e.classList.remove("cark-winner-pulse"),t())};requestAnimationFrame(i)})}_pickWinner(){const t=this.segments.reduce((a,r)=>a+r.probability,0);let e=Math.random()*t;for(const a of this.segments)if(e-=a.probability,e<=0)return a;return this.segments[this.segments.length-1]}}class _{constructor(t){this.container=t,this.canvas=document.createElement("canvas"),this.ctx=this.canvas.getContext("2d"),this.particles=[],this.colors=["#FF1E1E","#B00000","#FFFFFF","#C0C0C0","#1C1C1E"],this.isActive=!1,this.animationId=null,this.canvas.style.position="absolute",this.canvas.style.top="0",this.canvas.style.left="0",this.canvas.style.width="100%",this.canvas.style.height="100%",this.canvas.style.pointerEvents="none",this.canvas.style.zIndex="999"}fire(){this.container.appendChild(this.canvas),this.resize(),this.particles=Array.from({length:150}).map(()=>({x:this.canvas.width/2,y:this.canvas.height/2,vx:(Math.random()-.5)*20,vy:(Math.random()-.5)*20-5,size:Math.random()*8+4,color:this.colors[Math.floor(Math.random()*this.colors.length)],rotation:Math.random()*360,rotationSpeed:(Math.random()-.5)*10,shape:Math.random()>.5?"circle":"rect",life:1})),this.isActive=!0,this.animate(),setTimeout(()=>this.stop(),4e3)}resize(){this.canvas.width=this.container.clientWidth,this.canvas.height=this.container.clientHeight}animate(){if(!this.isActive)return;this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);let t=0;for(const e of this.particles)e.life<=0||(t++,e.x+=e.vx,e.y+=e.vy,e.vy+=.3,e.vx*=.98,e.rotation+=e.rotationSpeed,e.y>this.canvas.height*.8&&(e.life-=.02),this.ctx.save(),this.ctx.translate(e.x,e.y),this.ctx.rotate(e.rotation*Math.PI/180),this.ctx.globalAlpha=Math.max(0,e.life),this.ctx.fillStyle=e.color,e.shape==="circle"?(this.ctx.beginPath(),this.ctx.arc(0,0,e.size/2,0,Math.PI*2),this.ctx.fill()):this.ctx.fillRect(-e.size/2,-e.size/2,e.size,e.size),this.ctx.restore());t>0?this.animationId=requestAnimationFrame(()=>this.animate()):this.stop()}stop(){this.isActive=!1,this.animationId&&cancelAnimationFrame(this.animationId),this.canvas.parentNode&&this.canvas.parentNode.removeChild(this.canvas)}}class ${constructor(t,e,a){this.form=t,this.config=e,this.callbacks=a,this.errorContainer=this.form.querySelector("#cark-error"),this.inputs={name:this.form.querySelector("#cark-name"),phone:this.form.querySelector("#cark-phone"),email:this.form.querySelector("#cark-email"),kvkk1:this.form.querySelector("#cark-kvkk1"),kvkk2:this.form.querySelector("#cark-kvkk2")},this.setupListeners()}setupListeners(){this.inputs.phone.addEventListener("input",t=>{const e=t.target.value.replace(/\D/g,"").match(/(\d{0,3})(\d{0,3})(\d{0,2})(\d{0,2})/);e&&(e[1]&&e[1][0]!=="5"&&(e[1]="5"+e[1].substring(1)),t.target.value=e[2]?e[3]?e[4]?`${e[1]} ${e[2]} ${e[3]} ${e[4]}`:`${e[1]} ${e[2]} ${e[3]}`:`${e[1]} ${e[2]}`:e[1])}),this.form.addEventListener("submit",t=>{t.preventDefault();const e=this.validate();e.valid?this.callbacks.onSubmit&&this.callbacks.onSubmit(this.getData()):this.showError(e.errors[0])}),Object.values(this.inputs).forEach(t=>{t&&(t.addEventListener("input",()=>this.clearError()),t.addEventListener("change",()=>this.clearError()))})}validate(){const t=[];Object.values(this.inputs).forEach(n=>{n&&n.classList&&n.classList.remove("error")});const e=this.inputs.name.value.trim();(e.length<2||e.length>100||!new RegExp("\\p{L}","u").test(e))&&(t.push("Lütfen adınızı giriniz."),this.inputs.name.classList.add("error"));const a=this.inputs.phone.value.replace(/\D/g,"");(a.length!==10||!a.startsWith("5"))&&(t.push("Geçerli bir telefon numarası giriniz (5XX...)."),this.inputs.phone.classList.add("error"));const r=this.inputs.email.value.trim();return/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*\.[a-zA-Z]{2,}$/.test(r)||(t.push("Geçerli bir e-posta adresi giriniz (Türkçe karakter içermemeli)."),this.inputs.email.classList.add("error")),(!this.inputs.kvkk1.checked||!this.inputs.kvkk2.checked)&&t.push("Lütfen sözleşme ve aydınlatma metinlerini onaylayınız."),{valid:t.length===0,errors:t}}getData(){return{name:this.inputs.name.value.trim(),phone:this.inputs.phone.value.replace(/\D/g,""),email:this.inputs.email.value.trim()}}showError(t){this.errorContainer.textContent=t,this.errorContainer.style.animation="none",this.errorContainer.offsetHeight,this.errorContainer.style.animation="carkShake 0.4s ease"}clearError(){this.errorContainer.textContent=""}reset(){this.form.reset(),this.clearError()}}class B{constructor(t){this.config=t,this.els={}}buildDOM(t=null){const e=document.getElementById("cark-widget-root");if(e)if(t)e.remove();else return this.getElements();const a=document.createElement("div");return a.id="cark-widget-root",t&&a.classList.add("cark-preview-mode"),a.innerHTML=`
    ...
    `,(t||document.body).appendChild(a),this.getElements()}getElements(){const t=document.getElementById("cark-widget-root");return this.els={overlay:t.querySelector(".cark-overlay"),modal:t.querySelector(".cark-modal"),closeBtn:t.querySelector(".cark-close-btn"),canvas:t.querySelector(".cark-canvas"),form:t.querySelector(".cark-form"),formView:t.querySelector(".cark-form-view"),resultView:t.querySelector(".cark-result-view"),submitBtn:t.querySelector(".cark-submit-btn"),resIcon:t.querySelector(".cark-result-icon"),resTitle:t.querySelector(".cark-result-title"),resPrize:t.querySelector(".cark-result-prize"),couponContainer:t.querySelector("#cark-coupon-container"),couponText:t.querySelector("#cark-coupon-text"),copyBtn:t.querySelector("#cark-copy-btn"),ctaBtn:t.querySelector("#cark-cta-btn"),policyOverlay:t.querySelector("#cark-policy-overlay"),policyText:t.querySelector("#cark-policy-text"),policyCloseBtn:t.querySelector("#cark-policy-close"),policyLink:t.querySelector("#cark-kvkk-policy-link")},this.els}open(){this.els.overlay.classList.add("active"),document.body.style.overflow="hidden"}close(){if(this.els.overlay.classList.remove("active"),document.body.style.overflow="",this.els.resultView.style.display!=="block"){const t=new Date(Date.now()+36e5).toUTCString();document.cookie=`cark_closed=true;expires=${t};path=/;SameSite=Lax`}}showResult(t,e){if(this.els.formView.style.display="none",this.els.resultView.style.display="block",t.discountType==="noLuck")this.els.resIcon.textContent="😔",this.els.resTitle.textContent="Bir Dahaki Sefere!",this.els.resPrize.textContent=t.label||"Maalesef bu sefer boş geçtik.",this.els.couponContainer.style.display="none",this.els.ctaBtn.textContent="Tekrar Çevir 🔄",this.els.ctaBtn.onclick=()=>{e&&e()};else{if(this.els.resIcon.textContent=t.icon||"🎉",this.els.resTitle.textContent="Tebrikler!",this.els.resPrize.textContent=`${t.label} kazandınız!`,t.couponCode){this.els.couponContainer.style.display="block",this.els.couponText.textContent=t.couponCode,this.els.couponText.style.fontSize="",this.els.couponText.style.color="";const a=this.els.couponContainer.querySelector(".cark-coupon-label");a&&(a.textContent="İndirim Kodunuz:"),this.els.copyBtn&&(this.els.copyBtn.style.display="inline-flex")}else this.els.couponContainer.style.display="none";this.els.ctaBtn.textContent="Hemen Kullan →",this.els.ctaBtn.onclick=()=>{this.close()}}}reset(){this.els.formView.style.display="block",this.els.resultView.style.display="none"}setupPolicyLink(){if(!this.els.policyLink||!this.els.policyOverlay)return;this.els.policyText.textContent=this.config.kvkk.kvkkFullText||"";const t=a=>{a.preventDefault(),this.els.policyOverlay.classList.add("active")},e=()=>this.els.policyOverlay.classList.remove("active");this.els.policyLink.addEventListener("click",t),this.els.policyCloseBtn.addEventListener("click",e),this.els.policyOverlay.addEventListener("click",a=>{a.target===this.els.policyOverlay&&e()})}setupCopyButton(){this.els.copyBtn&&this.els.copyBtn.addEventListener("click",()=>{const t=this.els.couponText.textContent;t&&navigator.clipboard.writeText(t).then(()=>{const e=this.els.copyBtn.textContent;this.els.copyBtn.textContent="✅",setTimeout(()=>{this.els.copyBtn.textContent=e},2e3)})})}}const m={segments:[{id:1,label:"%10 İNDİRİM",color:"#D2001F",textColor:"#FFFFFF",probability:25,couponCode:null,discountType:"percentage",discountValue:10,icon:"🎁"},{id:2,label:"Kargo Bedava",color:"#1C1C1E",textColor:"#FFFFFF",probability:20,couponCode:null,discountType:"freeShipping",discountValue:0,icon:"🚚"},{id:3,label:"%15 İNDİRİM",color:"#48484A",textColor:"#FFFFFF",probability:15,couponCode:null,discountType:"percentage",discountValue:15,icon:"⭐"},{id:4,label:"50₺ İNDİRİM",color:"#8B0000",textColor:"#FFFFFF",probability:15,couponCode:null,discountType:"fixed",discountValue:50,icon:"💰"},{id:5,label:"%20 İNDİRİM",color:"#0A0A0A",textColor:"#FFFFFF",probability:10,couponCode:null,discountType:"percentage",discountValue:20,icon:"🔥"},{id:6,label:"Bir Dahaki Sefere",color:"#6E6E73",textColor:"#FFFFFF",probability:15,couponCode:null,discountType:"noLuck",discountValue:0,icon:"🔄"}],settings:{storeName:"Mağaza",cooldownHours:24,redirectUrl:"",webhookUrl:"",triggerType:"delay",triggerDelay:3e3,triggerScrollPercent:50},kvkk:{etiText:"Tanıtım, pazarlama, reklam ve benzeri amaçlarla tarafıma ticari elektronik ileti gönderilmesine izin veriyorum. Elektronik Ticari İleti Aydınlatma Metni'ni okudum onay veriyorum.",kvkkText:"Paylaştığım bilgilerin KVKK kapsamında tarafınızca korunmasını, sms ve WhatsApp üzerinden bilgilendirmeleri almayı kabul ediyorum.",kvkkFullText:""},theme:{wheelStyle:"premium",pointerStyle:"top",wheelSize:330,spinDurationMs:7e3,autoSiteTheme:!1,backgroundMode:"solid",popupOpacity:.82,backdropBlur:18,overlayOpacity:.55,popupLayout:"compact",inputTheme:"auto",backgroundImageUrl:"",primaryColor:"#FF1E1E",primaryColorDark:"#B00000",pointerColor:"#FF1E1E",bgDark:"#0A0A0A",bgMid:"#1C1C1E",bgLight:"#2C2C2E"}},E=()=>window.CARK_API_URL||"https://cark-backend.onrender.com",v=()=>window.CARK_STORE_SLUG||"";function w(){return E()}async function R(){const o=w(),t=v();if(t)try{const e=await fetch(`${o}/api/widget/${encodeURIComponent(t)}/config`);if(!e.ok){const r=await e.json().catch(()=>({})),i=new Error(r.error||"Çark yapılandırması alınamadı.");throw i.code=r.code||"CONFIG_FETCH_FAILED",i}const a=await e.json();return localStorage.setItem("carkConfig",JSON.stringify(a)),a}catch(e){throw console.error("Çark backend yapılandırması alınamadı:",e.message),e}return I()}function I(){try{const o=localStorage.getItem("carkConfig");if(o){const t=JSON.parse(o);return{...m,...t,settings:{...m.settings,...t.settings||{}},kvkk:{...m.kvkk,...t.kvkk||{}},theme:{...m.theme,...t.theme||{}},segments:t.segments||m.segments.map(e=>({...e}))}}}catch{}return JSON.parse(JSON.stringify(m))}function O(){return crypto.randomUUID?crypto.randomUUID():`${Date.now()}-${Math.random().toString(36).slice(2,9)}`}async function q(o,t=null){const e=w(),a=v();if(a){const h=t?{...o,segments:t}:o,g=await fetch(`${e}/api/widget/${encodeURIComponent(a)}/spin`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(h)});if(!g.ok){const k=await g.json().catch(()=>({}));throw new Error(k.error||"Spin hatası")}return g.json()}if(D().some(h=>h.email===o.email))throw new Error("Bu e-posta adresi ile zaten çarkı çevirdiniz.");const n=I().segments,s=t&&t.length>0?t:n,c=s.reduce((h,g)=>h+(g.probability||0),0);let d=Math.random()*c,l=s[s.length-1];for(const h of s)if(d-=h.probability||0,d<=0){l=h;break}const p={id:O(),timestamp:new Date().toISOString(),...o,prize:l.label,couponCode:l.couponCode};return G(p),{winner:l,entry:p}}let C=null;function W(){return C}async function b(){var s,c;const o=w(),t=v();if(t)try{const d=(c=(s=document.getElementById("cark-phone"))==null?void 0:s.value)==null?void 0:c.replace(/\D/g,"");if(d){const l=await fetch(`${o}/api/widget/${encodeURIComponent(t)}/check-spin`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:d})});if(l.ok){const p=await l.json();return C=p.canSpin?null:p.remainingMs??null,p.canSpin}}}catch{}if(L("cark_closed"))return!1;const e=L("cark_last_spin");if(!e)return!0;const a=parseInt(localStorage.getItem("carkCooldown")||"24"),r=Date.now()-parseInt(e,10),i=a*60*60*1e3,n=r>=i;return n?(document.cookie="cark_last_spin=;max-age=0;path=/",localStorage.removeItem("carkCooldown")):C=i-r,n}function V(o=24){const t=Date.now();X("cark_last_spin",t.toString(),o),localStorage.setItem("carkCooldown",o.toString())}function G(o){try{const t=JSON.parse(localStorage.getItem("carkEntries")||"[]");t.push(o),localStorage.setItem("carkEntries",JSON.stringify(t))}catch{}}function D(){try{return JSON.parse(localStorage.getItem("carkEntries")||"[]")}catch{return[]}}function X(o,t,e){const a=new Date(Date.now()+e*60*60*1e3).toUTCString();document.cookie=`${o}=${t};expires=${a};path=/;SameSite=Lax`}function L(o){const t=document.cookie.match(new RegExp("(^| )"+o+"=([^;]+)"));return t?t[2]:null}function S(o){const t=o&&o.match(/rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([\d.]+))?\)/);return!t||(t[4]===void 0?1:parseFloat(t[4]))===0?null:[Number(t[1]),Number(t[2]),Number(t[3])]}function N(o){let t=(o==null?void 0:o.parentElement)||document.body;for(;t;){const a=getComputedStyle(t),r=S(a.backgroundColor);if(r)return r;if(a.backgroundImage&&a.backgroundImage!=="none"){const i=S(a.color);if(i)return z(i)>.5?[22,26,34]:[248,250,252]}t=t.parentElement}const e=S(getComputedStyle(document.documentElement).backgroundColor);return e||null}function z([o,t,e]){const a=[o,t,e].map(r=>{const i=r/255;return i<=.03928?i/12.92:((i+.055)/1.055)**2.4});return a[0]*.2126+a[1]*.7152+a[2]*.0722}function U([o,t,e]){o/=255,t/=255,e/=255;const a=Math.max(o,t,e),r=Math.min(o,t,e);let i=0,n=0;const s=(a+r)/2,c=a-r;if(c!==0){switch(n=s>.5?c/(2-a-r):c/(a+r),a){case o:i=(t-e)/c+(t<e?6:0);break;case t:i=(e-o)/c+2;break;default:i=(o-t)/c+4}i/=6}return[i*360,n,s]}function K(o){const t=N(o)||[255,255,255],[e,a]=U(t),r=z(t)>=.48,n=a<.06?8:Math.min(55,Math.max(a*100,24)),s=e.toFixed(1);return{isLight:r,mode:r?"light":"dark",bgDark:r?`hsl(${s} ${(n*.45).toFixed(0)}% 98%)`:`hsl(${s} ${n.toFixed(0)}% 9%)`,bgMid:r?`hsl(${s} ${(n*.6).toFixed(0)}% 94%)`:`hsl(${s} ${n.toFixed(0)}% 17%)`,bgLight:r?`hsl(${s} ${(n*.7).toFixed(0)}% 91%)`:`hsl(${s} ${(n*.9).toFixed(0)}% 14%)`}}function M(o,t,e,a){const r=Number(o);return Number.isFinite(r)?Math.min(e,Math.max(t,r)):a}function Y(o){if(!o)return"";try{const t=new URL(o,window.location.href);return["http:","https:","data:"].includes(t.protocol)?`url("${t.href.replace(/["\\]/g,"\\$&")}")`:""}catch{return""}}function H(o,t={}){if(!o)return;if(o.classList.toggle("cark-pointer-center",t.pointerStyle==="center"),o.classList.toggle("cark-style-standard",t.wheelStyle==="standard"),t.primaryColor){o.style.setProperty("--cark-primary",t.primaryColor);const h=parseInt(t.primaryColor.replace("#",""),16);o.style.setProperty("--cark-primary-rgb",`${h>>16&255}, ${h>>8&255}, ${h&255}`)}t.primaryColorDark&&o.style.setProperty("--cark-primary-dark",t.primaryColorDark),t.pointerColor&&o.style.setProperty("--cark-pointer-color",t.pointerColor);const e=t.backgroundMode||(t.autoSiteTheme!==!1?"auto":"solid"),a=["auto","darkGlass","lightGlass","solid","image"].includes(e)?e:"auto",r=K(o),i=a==="auto"?r.mode:a==="lightGlass"?"light":"dark",n=t.inputTheme==="light"||t.inputTheme==="dark"?t.inputTheme:i;["auto","dark-glass","light-glass","solid","image"].forEach(h=>{o.classList.remove(`cark-bg-${h}`)}),o.classList.add(`cark-bg-${a==="darkGlass"?"dark-glass":a==="lightGlass"?"light-glass":a}`),o.classList.toggle("cark-host-light",i==="light"),o.classList.toggle("cark-host-dark",i!=="light"),o.classList.toggle("cark-layout-wide",t.popupLayout==="wide"),o.classList.toggle("cark-layout-compact",t.popupLayout!=="wide"),o.classList.toggle("cark-input-light",n==="light"),o.classList.toggle("cark-input-dark",n!=="light"),o.style.setProperty("--cark-popup-opacity",M(t.popupOpacity,.55,1,.82)),o.style.setProperty("--cark-backdrop-blur",`${M(t.backdropBlur,0,32,18)}px`),o.style.setProperty("--cark-overlay-opacity",M(t.overlayOpacity,.15,.85,.55));const s=Y(t.backgroundImageUrl);o.style.setProperty("--cark-background-image",s||"none");const c=a==="auto",d=c?r.bgDark:t.bgDark,l=c?r.bgMid:t.bgMid,p=c?r.bgLight:t.bgLight;d&&o.style.setProperty("--cark-bg-dark",d),l&&o.style.setProperty("--cark-bg-mid",l),p&&o.style.setProperty("--cark-bg-light",p)}function j(o){const t=Math.floor(o/36e5),e=Math.floor(o%36e5/6e4);return t>0?`${t} saat ${e} dakika`:`${Math.max(1,e)} dakika`}const J=`
...
`;class Z{constructor(){this.config=null,this.hasOpened=!1}async init(t={}){const e=setTimeout(()=>this.showLoadingIndicator(),1200);try{this.config=await R()}finally{clearTimeout(e),this.hideLoadingIndicator()}this.embedOptions=t,t.segments&&(this.config.segments=t.segments),t.storeName&&(this.config.settings.storeName=t.storeName),t.cooldownHours!==void 0&&(this.config.settings.cooldownHours=t.cooldownHours),this.injectStyles(),this.modalMgr=new B(this.config);const a=this.modalMgr.buildDOM();H(document.getElementById("cark-widget-root"),this.config.theme||{}),this.wheel=new A(a.canvas,this.config),this.confetti=new _(a.modal),this.formMgr=new $(a.form,this.config,{onSubmit:r=>this.handleSpin(r)}),a.closeBtn.addEventListener("click",()=>this.close()),a.ctaBtn.addEventListener("click",()=>{this.config.settings.redirectUrl?window.location.href=this.config.settings.redirectUrl:this.close()}),this.modalMgr.setupCopyButton(),this.modalMgr.setupPolicyLink(),a.overlay.addEventListener("click",r=>{r.target===a.overlay&&this.close()}),this.setupTriggers()}injectStyles(){if(document.getElementById("cark-widget-styles"))return;const t=document.createElement("style");t.id="cark-widget-styles",t.textContent=J,document.head.appendChild(t)}showLoadingIndicator(){if(document.getElementById("cark-loading-indicator"))return;const t=document.createElement("div");if(t.id="cark-loading-indicator",t.setAttribute("aria-hidden","true"),t.style.cssText="position:fixed;bottom:20px;right:20px;width:14px;height:14px;border-radius:50%;background:#FF1E1E;z-index:999998;pointer-events:none;animation:carkLoadingPulse 1.4s ease-out infinite;",!document.getElementById("cark-loading-indicator-keyframes")){const e=document.createElement("style");e.id="cark-loading-indicator-keyframes",e.textContent="@keyframes carkLoadingPulse{0%{box-shadow:0 0 0 0 rgba(255,30,30,0.6);}70%{box-shadow:0 0 0 14px rgba(255,30,30,0);}100%{box-shadow:0 0 0 0 rgba(255,30,30,0);}}",document.head.appendChild(e)}document.body.appendChild(t)}hideLoadingIndicator(){var t;(t=document.getElementById("cark-loading-indicator"))==null||t.remove()}setupTriggers(){const t=this.config.settings;if(t.triggerType==="delay")setTimeout(async()=>{!this.hasOpened&&await b()&&this.open()},t.triggerDelay||3e3);else if(t.triggerType==="scroll"){const e=async()=>{window.scrollY/(document.documentElement.scrollHeight-window.innerHeight)*100>=(t.triggerScrollPercent||50)&&(!this.hasOpened&&await b()&&this.open(),window.removeEventListener("scroll",e))};window.addEventListener("scroll",e)}else if(t.triggerType==="exitIntent"){const e=async a=>{(a.clientY<=0||a.clientX<=0||a.clientX>=window.innerWidth||a.clientY>=window.innerHeight)&&(!this.hasOpened&&await b()&&this.open(),document.removeEventListener("mouseleave",e))};document.addEventListener("mouseleave",e)}}async handleSpin(t){if(!await b()){const a=W();this.formMgr.showError(a?`Tekrar çevirmek için ${j(a)} beklemelisiniz.`:"Şu anda çarkı çeviremezsiniz. Lütfen daha sonra tekrar deneyin.");return}const e=this.modalMgr.getElements().submitBtn;e.disabled=!0,e.textContent="Dönüyor...";try{const r=(await q({name:t.name,phone:t.phone,email:t.email})).winner;await this.wheel.spin(r),r.discountType!=="noLuck"&&V(this.config.settings.cooldownHours||24),setTimeout(()=>{r.discountType!=="noLuck"&&this.confetti.fire(),this.modalMgr.showResult(r)},500)}catch(a){e.disabled=!1,e.textContent="Çevir Kazan",this.formMgr.showError(a.message||"Bir hata oluştu"),console.error(a)}}async open(){if(!await b()){console.warn("CarkWidget: canSpin() false, çark açılmıyor (cooldown aktif veya backend izin vermedi).");return}this.hasOpened=!0,this.modalMgr.open(),setTimeout(()=>this.wheel.render(),100)}close(){this.modalMgr.close()}}const T=new Z;function Q(o){document.body?o():document.addEventListener("DOMContentLoaded",o,{once:!0})}window.CarkWidget={init:(o={})=>new Promise(t=>{o.apiBaseUrl&&(window.CARK_API_URL=o.apiBaseUrl),o.storeSlug&&(window.CARK_STORE_SLUG=o.storeSlug),Q(async()=>{await T.init(o),t()})}),open:()=>T.open(),close:()=>T.close()}})();
