import{g as F,s as x,D as z,a as L,M as D,b as K,W as O,c as H,d as G,e as j}from"./main-DGlLGr8_.js";function P(S,e,t){const n=e||"https://BACKEND-URLINIZ";return`<!-- Çark Çevir Kazan Widget -->
...
<div class="ikas-guide">
  ...
  <ul>
                ...
                ${e.map((t,n)=>`
                  <div class="segment-item" data-id="${t.couponGroupId}">
                    ...
                    <div class="segment-info">
                      <div class="segment-label" style="color:${t.textColor||"#fff"}">${m(t.icon)} ${m(t.label)}</div>
                      <div class="segment-meta">Çarkta ${t.sliceCount} dilim • Kazanma ağırlığı: %${Number(t.probability.toFixed(1))} ${t.couponCode?`• Kod: ${m(t.couponCode)}`:""} ${t.ikasCampaignId?"• İkas kampanyasına bağlı":""}</div>
                    </div>
                    <div class="segment-actions">
                      ...
                      ${t.discountType!=="noLuck"?`<button class="test-coupon-btn" data-id="${m(t.id)}" title="İkas kampanyasına gerçek bir test kuponu ekle">🧪 Test Et</button>`:""}
    ...
    `}setupAppearanceListeners(){var s,o,r;this.setupStyleOptionGroup("wheelStyleOptions"),this.setupStyleOptionGroup("pointerStyleOptions");const e=document.getElementById("theme-autoSiteTheme"),t=document.getElementById("manualBgColors");e.addEventListener("change",()=>{t.style.display=e.checked?"none":"block",this.renderLivePreview("appearancePreviewContainer",this.readAppearanceForm())}),document.getElementById("theme-wheelSize").addEventListener("input",d=>{document.getElementById("theme-wheelSize-val").textContent=`${d.target.value}px`,this.renderLivePreview("appearancePreviewContainer",this.readAppearanceForm())}),document.getElementById("theme-spinDuration").addEventListener("input",d=>{document.getElementById("theme-spinDuration-val").textContent=`${(d.target.value/1e3).toFixed(1)} sn`}),["theme-primaryColor","theme-primaryColorDark","theme-pointerColor","theme-bgDark","theme-bgMid","theme-bgLight"].forEach(d=>{document.getElementById(d).addEventListener("input",l=>{const u=document.querySelector(`[data-color-for="${d}"]`);u&&(u.textContent=l.target.value.toUpperCase()),this.renderLivePreview("appearancePreviewContainer",this.readAppearanceForm())})});const i=()=>{const d=document.getElementById("appearanceSaveStatus"),l=document.querySelector(".appearance-save-bar");d&&(d.textContent="Kaydedilmemiş değişiklikler var."),l==null||l.classList.add("dirty")};(s=document.querySelector(".appearance-controls"))==null||s.addEventListener("input",i),(o=document.querySelector(".appearance-controls"))==null||o.addEventListener("change",i),(r=document.querySelector(".appearance-controls"))==null||r.addEventListener("click",d=>{d.target.closest(".wheel-style-option")&&i()}),document.getElementById("saveAppearanceBtn").addEventListener("click",async d=>{const l=d.currentTarget;l.disabled=!0,l.textContent="Kaydediliyor...";const u=this.readAppearanceForm(),p=await this.saveAndRender({theme:u}),v=document.getElementById("appearanceSaveStatus");v&&(v.textContent=p?"Tüm görünüm ayarları kaydedildi.":"Ayarlar bu tarayıcıda kaydedildi; backend bağlantısı yok.")})}setupStyleOptionGroup(e){const t=document.getElementById(e),n=a=>{t.querySelectorAll(".wheel-style-option").forEach(i=>{i.classList.remove("active"),i.setAttribute("aria-checked","false")}),a.classList.add("active"),a.setAttribute("aria-checked","true"),this.renderLivePreview("appearancePreviewContainer",this.readAppearanceForm())};t.addEventListener("click",a=>{const i=a.target.closest(".wheel-style-option");i&&n(i)}),t.addEventListener("keydown",a=>{if(a.key!=="Enter"&&a.key!==" ")return;const i=a.target.closest(".wheel-style-option");i&&(a.preventDefault(),n(i))})}readAppearanceForm(){var e,t;return{wheelStyle:((e=document.querySelector("#wheelStyleOptions .wheel-style-option.active"))==null?void 0:e.dataset.style)||"premium",pointerStyle:((t=document.querySelector("#pointerStyleOptions .wheel-style-option.active"))==null?void 0:t.dataset.pointerStyle)||"top",autoSiteTheme:document.getElementById("theme-autoSiteTheme").checked,primaryColor:document.getElementById("theme-primaryColor").value,primaryColorDark:document.getElementById("theme-primaryColorDark").value,pointerColor:document.getElementById("theme-pointerColor").value,bgDark:document.getElementById("theme-bgDark").value,bgMid:document.getElementById("theme-bgMid").value,bgLight:document.getElementById("theme-bgLight").value,wheelSize:parseInt(document.getElementById("theme-wheelSize").value)||330,spinDurationMs:parseInt(document.getElementById("theme-spinDuration").value)||7e3}}openSegmentModal(e){this.editingSegmentId=e;const t=this.getCouponTemplates();let n=e?t.find(a=>String(a.couponGroupId)===String(e)):null;if(!n){const a=["#1E3A8A","#9F1239","#065F46","#B8860B","#6B21A8","#92400E","#831843"];n={couponGroupId:`coupon-${L()}`,label:"Yeni Ödül",color:a[Math.floor(Math.random()*a.length)],textColor:"#FFFFFF",probability:10,couponCode:"",ikasCampaignId:null,discountType:"percentage",discountValue:0,icon:"🎁"}}document.getElementById("editModalContent").innerHTML=`
      ...
      <details class="segment-advanced" ${n.couponCode?"open":""}>
        ...
        <div class="form-group" id="seg-coupon-group">
          ...
          <input type="text" class="form-input" id="seg-coupon" value="${m(n.couponCode)}" placeholder="Örn: YH30 — İkas'ta zaten oluşturduğunuz bir kod">
        </div>
    ...
    `}setupEntriesListeners(){var n,a,i,s,o,r,d,l,u,p,v,w,f,k;this.entriesPage=this.entriesPage||1,this.entriesPageSize=this.entriesPageSize||25,this.entriesFilters=this.entriesFilters||{dateFrom:"",dateTo:"",prize:"",status:"",search:""},this.selectedEntryIds=new Set,this.loadEntries();const e=()=>{this.entriesFilters={dateFrom:document.getElementById("entriesDateFrom").value,dateTo:document.getElementById("entriesDateTo").value,prize:document.getElementById("entriesPrizeFilter").value,status:document.getElementById("entriesStatusFilter").value,search:document.getElementById("entriesSearch").value.trim()},this.entriesPage=1,this.selectedEntryIds.clear(),this.loadEntries()};["entriesDateFrom","entriesDateTo","entriesPrizeFilter","entriesStatusFilter"].forEach(b=>{var c;(c=document.getElementById(b))==null||c.addEventListener("change",e)});let t;(n=document.getElementById("entriesSearch"))==null||n.addEventListener("input",()=>{clearTimeout(t),t=setTimeout(e,350)}),(a=document.getElementById("resetEntriesFiltersBtn"))==null||a.addEventListener("click",()=>{this.entriesFilters={dateFrom:"",dateTo:"",prize:"",status:"",search:""},["entriesDateFrom","entriesDateTo","entriesPrizeFilter","entriesStatusFilter","entriesSearch"].forEach(b=>{const c=document.getElementById(b);c&&(c.value="")}),this.entriesPage=1,this.selectedEntryIds.clear(),this.loadEntries()}),(i=document.getElementById("exportBtn"))==null||i.addEventListener("click",()=>this.downloadEntries("csv")),(s=document.getElementById("exportExcelBtn"))==null||s.addEventListener("click",()=>this.downloadEntries("excel")),(o=document.getElementById("exportBrokenBtn"))==null||o.addEventListener("click",()=>this.downloadEntries("csv",{status:"failed"})),(r=document.getElementById("showBrokenBtn"))==null||r.addEventListener("click",()=>{var b;document.getElementById("entriesStatusFilter").value="failed",e(),(b=document.getElementById("entriesContainer"))==null||b.scrollIntoView({behavior:"smooth",block:"start"})}),(d=document.getElementById("retryBrokenBtn"))==null||d.addEventListener("click",()=>this.retryAllBrokenEntries()),(l=document.getElementById("clearEntriesBtn"))==null||l.addEventListener("click",async()=>{if(!confirm("Tüm katılımcı verileri silinecek. Emin misiniz?"))return;const b=h();g()?await fetch(`${b}/api/admin/entries`,{method:"DELETE",headers:{Authorization:`Bearer ${g()}`}}):H(),this.entriesPage=1,this.loadEntries(),this.showToast("Veriler silindi")}),(u=document.getElementById("entriesBulkToolbar"))==null||u.addEventListener("click",b=>{var y;const c=(y=b.target.closest("[data-bulk-action]"))==null?void 0:y.dataset.bulkAction;c&&this.handleEntriesBulkAction(c)}),(p=document.getElementById("createTestEntryBtn"))==null||p.addEventListener("click",()=>this.createTestEntry()),(v=document.getElementById("checkWidgetStatusBtn"))==null||v.addEventListener("click",()=>this.checkWidgetStatus()),(w=document.getElementById("openInstallGuideBtn"))==null||w.addEventListener("click",()=>{var b;(b=document.querySelector('.admin-nav a[data-tab="integration"]'))==null||b.click()}),(f=document.getElementById("closeEntryDetailBtn"))==null||f.addEventListener("click",()=>this.closeEntryDetail()),(k=document.getElementById("entryDetailScrim"))==null||k.addEventListener("click",()=>this.closeEntryDetail())}async loadEntries(){var p,v,w,f,k,b;const e=document.getElementById("entriesContainer");if(!e)return;const t=h(),n=this.entriesPageSize||25;e.innerHTML='<div class="entries-loading-state"><div class="entries-spinner"></div><span>Katılımcılar yükleniyor...</span></div>';let a,i={total:0,today:0,processed:0,failed:0,conversionRate:0,mostWon:"-",prizeDistribution:[]},s=0,o=[];if(g())try{const c=g(),y=this.entriesQueryParams();y.set("page",this.entriesPage||1),y.set("limit",n);const[B,E]=await Promise.all([fetch(`${t}/api/admin/entries?${y}`,{headers:{Authorization:`Bearer ${c}`}}),fetch(`${t}/api/admin/stats`,{headers:{Authorization:`Bearer ${c}`}})]);if(!B.ok||!E.ok)throw new Error("Katılımcılar yüklenemedi");const I=await B.json();a=I.entries||[],s=I.total||0,o=I.prizes||[],i=await E.json()}catch(c){e.innerHTML=`<div class="entries-error-state"><strong>Katılımcılar yüklenemedi</strong><span>${m(c.message)}</span><button class="btn btn-secondary" id="retryEntriesLoadBtn">Tekrar dene</button></div>`,(p=document.getElementById("retryEntriesLoadBtn"))==null||p.addEventListener("click",()=>this.loadEntries());return}else{a=G();const c=new Date().toISOString().split("T")[0];i.total=a.length,i.today=a.filter(B=>{var E;return(E=B.timestamp)==null?void 0:E.startsWith(c)}).length;const y=a.map(B=>B.prize).filter(Boolean);if(y.length>0){const B=y.reduce((E,I)=>(E[I]=(E[I]||0)+1,E),{});i.mostWon=Object.keys(B).reduce((E,I)=>B[E]>B[I]?E:I)}}this.currentEntries=a,this.currentEntryMap=new Map(a.map(c=>[String(c.id),c]));const r=document.getElementById("entriesPrizeFilter");if(r){const c=((v=this.entriesFilters)==null?void 0:v.prize)||"";r.innerHTML=`<option value="">Tüm ödüller</option>${o.map(y=>`<option value="${m(y)}">${m(y)}</option>`).join("")}`,r.value=c}document.getElementById("stat-total").textContent=i.total,document.getElementById("stat-today").textContent=i.today,document.getElementById("stat-mostwon").textContent=i.mostWon,document.getElementById("stat-processed").textContent=i.processed??0,document.getElementById("stat-broken").textContent=i.failed??i.brokenCoupons??0,document.getElementById("stat-conversion").textContent=`%${i.conversionRate??0}`;const d=i.failed??i.brokenCoupons??0,l=document.getElementById("entriesIssueBanner");if(l.hidden=d===0,document.getElementById("entriesIssueCount").textContent=d,this.renderPrizeDistribution(i.prizeDistribution||[]),g()?s===0:a.length===0){const c=Object.values(this.entriesFilters||{}).some(Boolean);e.innerHTML=c?'<div class="entries-empty-state"><div>🔎</div><strong>Filtrelere uygun katılımcı bulunamadı</strong><span>Filtreleri değiştirerek tekrar deneyin.</span><button class="btn btn-secondary" id="emptyResetFiltersBtn">Filtreleri temizle</button></div>':'<div class="entries-empty-state"><div>🎡</div><strong>Henüz katılımcı yok</strong><span>Çark sitenize eklendikten sonra katılımlar burada görünür.</span></div>',(w=document.getElementById("emptyResetFiltersBtn"))==null||w.addEventListener("click",()=>{var y;return(y=document.getElementById("resetEntriesFiltersBtn"))==null?void 0:y.click()});return}e.innerHTML=`
      <table class="entries-table">
        ...
        <tbody>
          ${a.map(c=>`
            <tr class="entry-row" data-entry-id="${m(c.id)}" tabindex="0">
              <td><input type="checkbox" class="entry-select" value="${m(c.id)}" ${this.selectedEntryIds.has(String(c.id))?"checked":""} aria-label="${m(c.name||"Katılımcı")} kaydını seç"></td>
              <td>${c.timestamp?new Date(c.timestamp).toLocaleString("tr-TR"):"-"}</td>
              <td>${m(c.name)||"-"}</td>
              <td><span class="masked-value" data-field="phone">${m(this.maskPhone(c.phone))||"-"}</span>${c.phone?'<button class="reveal-entry-value" data-field="phone" title="Telefonu göster">Göster</button>':""}</td>
              <td><span class="masked-value" data-field="email">${m(this.maskEmail(c.email))||"-"}</span>${c.email?'<button class="reveal-entry-value" data-field="email" title="E-postayı göster">Göster</button>':""}</td>
              <td class="entry-prize-cell">${m(c.prize)||"-"}</td>
              <td>${c.couponCode?`<code>${m(c.couponCode)}</code>`:"-"}</td>
    ...
    `,(f=document.getElementById("entriesPrevBtn"))==null||f.addEventListener("click",()=>{this.entriesPage=Math.max(1,this.entriesPage-1),this.loadEntries()}),(k=document.getElementById("entriesNextBtn"))==null||k.addEventListener("click",()=>{this.entriesPage+=1,this.loadEntries()}),(b=document.getElementById("entriesPageSize"))==null||b.addEventListener("change",c=>{this.entriesPageSize=parseInt(c.target.value,10)||25,this.entriesPage=1,this.loadEntries()}),this.bindEntryTableListeners(),this.updateEntriesBulkToolbar()}entriesQueryParams(e={}){const t=new URLSearchParams,n={...this.entriesFilters||{},...e};return Object.entries(n).forEach(([a,i])=>{i&&t.set(a,i)}),t}maskPhone(e){const t=String(e||"").replace(/\s/g,"");return t.length<7?t:`${t.slice(0,3)}****${t.slice(-3)}`}maskEmail(e){const t=String(e||""),[n,a]=t.split("@");return a?`${n.slice(0,3)}***@${a}`:t}entryStatusMeta(e){return{processed:{label:"İkas'a işlendi",className:"status-processed",icon:"✓"},pending:{label:"Beklemede",className:"status-pending",icon:"●"},failed:{label:"İşlenemedi",className:"status-failed",icon:"!"},manual_review:{label:"Manuel kontrol gerekli",className:"status-manual",icon:"◆"}}[e]||{label:"Bilinmiyor",className:"status-manual",icon:"?"}}renderEntryStatus(e){const t=e.couponStatus||(e.isLocalCoupon?"failed":e.couponCode?"processed":"manual_review"),n=this.entryStatusMeta(t);return`<span class="entry-status ${n.className}" title="${m(e.couponError||n.label)}"><b>${n.icon}</b>${n.label}</span>`}bindEntryTableListeners(){var e;(e=document.getElementById("selectAllEntries"))==null||e.addEventListener("change",t=>{document.querySelectorAll(".entry-select").forEach(n=>{n.checked=t.target.checked,t.target.checked?this.selectedEntryIds.add(String(n.value)):this.selectedEntryIds.delete(String(n.value))}),this.updateEntriesBulkToolbar()}),document.querySelectorAll(".entry-select").forEach(t=>{t.addEventListener("change",()=>{t.checked?this.selectedEntryIds.add(String(t.value)):this.selectedEntryIds.delete(String(t.value)),this.updateEntriesBulkToolbar()})}),document.querySelectorAll(".reveal-entry-value").forEach(t=>{t.addEventListener("click",n=>{n.stopPropagation();const a=this.currentEntryMap.get(String(t.closest("tr").dataset.entryId));t.parentElement.querySelector(".masked-value").textContent=(a==null?void 0:a[t.dataset.field])||"-",t.remove()})}),document.querySelectorAll(".entry-row").forEach(t=>{var a;const n=i=>{i.target.closest("input, button, a")||this.openEntryDetail(t.dataset.entryId)};t.addEventListener("click",n),t.addEventListener("keydown",i=>{i.key==="Enter"&&n(i)}),(a=t.querySelector(".entry-detail-btn"))==null||a.addEventListener("click",()=>this.openEntryDetail(t.dataset.entryId))})}updateEntriesBulkToolbar(){const e=document.getElementById("entriesBulkToolbar");e&&(e.hidden=this.selectedEntryIds.size===0,document.getElementById("selectedEntriesCount").textContent=this.selectedEntryIds.size)}async downloadEntries(e="csv",t={},n=[]){if(!g()){j();return}try{const a=this.entriesQueryParams(t);e==="excel"&&a.set("format","excel"),n.length&&a.set("ids",n.join(","));const i=await fetch(`${h()}/api/admin/entries/export?${a}`,{headers:{Authorization:`Bearer ${g()}`}});if(!i.ok)throw new Error("Dışa aktarma başarısız");const s=await i.blob(),o=URL.createObjectURL(s),r=document.createElement("a");r.href=o,r.download=`cark-katilimcilar-${new Date().toISOString().split("T")[0]}.${e==="excel"?"xls":"csv"}`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(o),this.showToast(`${e==="excel"?"Excel":"CSV"} dosyası indiriliyor`)}catch(a){this.showToast(a.message,"error")}}async handleEntriesBulkAction(e){const t=[...this.selectedEntryIds];if(!t.length)return;if(e==="export"){await this.downloadEntries("csv",{},t);return}const n={delete:"silmek",retry:"İkas'a tekrar göndermek",mark_processed:"manuel işlendi işaretlemek"};if(confirm(`${t.length} kaydı ${n[e]} istediğinize emin misiniz?`))try{const a=await fetch(`${h()}/api/admin/entries/bulk`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${g()}`},body:JSON.stringify({ids:t,action:e})}),i=await a.json().catch(()=>({}));if(!a.ok)throw new Error(i.error||"Toplu işlem tamamlanamadı");this.selectedEntryIds.clear(),await this.loadEntries(),this.showToast(`${i.affected||t.length} kayıt güncellendi${i.failed?`, ${i.failed} kayıt kontrol bekliyor`:""}`)}catch(a){this.showToast(a.message,"error")}}async retryAllBrokenEntries(){try{const e=this.entriesQueryParams({status:"failed"});e.set("page",1),e.set("limit",500);const t=await fetch(`${h()}/api/admin/entries?${e}`,{headers:{Authorization:`Bearer ${g()}`}}),n=await t.json();if(!t.ok)throw new Error(n.error||"Sorunlu kayıtlar alınamadı");const a=(n.entries||[]).map(i=>i.id);if(!a.length)return this.showToast("Tekrar işlenecek kayıt yok");this.selectedEntryIds=new Set(a),await this.handleEntriesBulkAction("retry")}catch(e){this.showToast(e.message,"error")}}renderPrizeDistribution(e){const t=document.getElementById("entriesPrizeChart");if(!t)return;if(!e.length){t.innerHTML='<div class="entries-chart-empty">Ödül verisi henüz oluşmadı.</div>';return}const n=Math.max(...e.map(a=>a.count),1);t.innerHTML=e.map(a=>`<div class="prize-chart-row"><div class="prize-chart-label"><strong>${m(a.prize)}</strong><span>${a.count} toplam • ${a.todayCount} bugün</span></div><div class="prize-chart-track"><div style="width:${Math.max(4,a.count/n*100)}%"></div></div></div>`).join("")}openEntryDetail(e){var s,o;const t=(s=this.currentEntryMap)==null?void 0:s.get(String(e));if(!t)return;const n=this.entryStatusMeta(t.couponStatus);document.getElementById("entryDetailTitle").textContent=t.name||"İsimsiz katılımcı",document.getElementById("entryDetailContent").innerHTML=`
      ...
      ${t.couponError?`<div class="entry-error-box"><strong>Hata nedeni</strong><span>${m(t.couponError)}</span></div>`:""}
