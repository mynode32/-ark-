import{g as F,s as z,D as x,a as L,M as D,b as K,W as O,c as H,d as G,e as j}from"./main-DGlLGr8_.js";function P(S,e,t){const n=e||"https://BACKEND-URLINIZ";return`<!-- Çark Çevir Kazan Widget -->
                ...
                ${e.map((t,n)=>`
                  <div class="segment-item" data-id="${t.couponGroupId}">
                    ...
                    <div class="segment-actions">
                      ...
                      ${t.discountType!=="noLuck"?`<button class="test-coupon-btn" data-id="${m(t.id)}" title="Bu kupon gerçek bir müşteri kazanmadan İkas'ta üretilebiliyor mu test et">🧪</button>`:""}
