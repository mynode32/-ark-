import"./modulepreload-polyfill-B5Qt9EMX.js";import{D as C,g as x,M as j,a as H,W as R}from"./main-5OnLB0RW.js";const T=[{id:"klasik",name:"Klasik Kırmızı",segments:["#D2001F","#1C1C1E","#48484A","#8B0000","#0A0A0A","#6E6E73"],theme:{primaryColor:"#FFD700",primaryColorDark:"#FFA502",pointerColor:"#FF4757",bgDark:"#0F0C29",bgMid:"#302B63",bgLight:"#24243E"}},{id:"gece-mavisi",name:"Gece Mavisi",segments:["#1D4ED8","#0F172A","#334155","#1E3A8A","#0B1220","#475569"],theme:{primaryColor:"#38BDF8",primaryColorDark:"#0EA5E9",pointerColor:"#F43F5E",bgDark:"#0B1220",bgMid:"#1E293B",bgLight:"#334155"}},{id:"zumrut",name:"Zümrüt Yeşili",segments:["#059669","#065F46","#064E3B","#10B981","#022C22","#34D399"],theme:{primaryColor:"#34D399",primaryColorDark:"#10B981",pointerColor:"#F59E0B",bgDark:"#022C22",bgMid:"#064E3B",bgLight:"#0B3B2E"}},{id:"kraliyet-moru",name:"Kraliyet Moru",segments:["#7C3AED","#4C1D95","#2E1065","#8B5CF6","#1E1B4B","#A78BFA"],theme:{primaryColor:"#C084FC",primaryColorDark:"#A855F7",pointerColor:"#F472B6",bgDark:"#1E1B4B",bgMid:"#312E81",bgLight:"#0F0B2E"}},{id:"gun-batimi",name:"Gün Batımı",segments:["#F97316","#C2410C","#7C2D12","#EA580C","#9A3412","#FB923C"],theme:{primaryColor:"#FBBF24",primaryColorDark:"#F59E0B",pointerColor:"#EF4444",bgDark:"#431407",bgMid:"#7C2D12",bgLight:"#27150A"}}],A=[...new Set(T.flatMap(f=>f.segments))],G="carkAdminConfig:";function P(f){return JSON.parse(JSON.stringify(f))}function M(f){if(!f)throw new Error("Mağaza kimliği olmadan admin önbelleği kullanılamaz");return`${G}${f}`}function q(f,e,t){try{const n=f.getItem(M(e));return n?JSON.parse(n):P(t)}catch{return P(t)}}function _(f,e,t){f.setItem(M(e),JSON.stringify(t))}function V(f,e={}){if(f){const t=String(f.type||"").toUpperCase();return{discountType:f.isFreeShipping===!0&&(!t||t==="FREE_SHIPPING")?"freeShipping":"ikasCampaign",discountValue:null}}return{discountType:e.discountType||"percentage",discountValue:Number.isFinite(e.discountValue)?e.discountValue:0}}function U({discountType:f,discountValue:e}={}){return f==="freeShipping"?"Ücretsiz Kargo":f==="percentage"&&Number.isFinite(Number(e))?`%${Number(e)}`:f==="fixed"&&Number.isFinite(Number(e))?`${Number(e)} TL`:f==="ikasCampaign"?"İndirim değeri İkas kampanyası tarafından belirlenir":""}function F(f,e,t){const n=e||"https://BACKEND-URLINIZ";return`<!-- Çark Çevir Kazan Widget -->
