import{g as F,s as x,D as z,a as L,M as D,b as K,W as O,c as G,d as H,e as j}from"./main-BriaYEUM.js";function P(S,e,t){const n=e||"https://BACKEND-URLINIZ";return`<!-- Çark Çevir Kazan Widget -->
                ...
                ${e.map((t,n)=>`
                  <div class="segment-item" data-id="${t.couponGroupId}">
                    ...
                    <div class="segment-info">
                      <div class="segment-label" style="color:${t.textColor||"#fff"}">${p(t.icon)} ${p(t.label)}</div>
