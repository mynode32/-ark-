import"./modulepreload-polyfill-B5Qt9EMX.js";import{D as C,g as A,M as j,a as H,W as G}from"./main-5OnLB0RW.js";const $=[{id:"klasik",name:"Klasik Kırmızı",segments:["#D2001F","#1C1C1E","#48484A","#8B0000","#0A0A0A","#6E6E73"],theme:{primaryColor:"#FFD700",primaryColorDark:"#FFA502",pointerColor:"#FF4757",bgDark:"#0F0C29",bgMid:"#302B63",bgLight:"#24243E"}},{id:"gece-mavisi",name:"Gece Mavisi",segments:["#1D4ED8","#0F172A","#334155","#1E3A8A","#0B1220","#475569"],theme:{primaryColor:"#38BDF8",primaryColorDark:"#0EA5E9",pointerColor:"#F43F5E",bgDark:"#0B1220",bgMid:"#1E293B",bgLight:"#334155"}},{id:"zumrut",name:"Zümrüt Yeşili",segments:["#059669","#065F46","#064E3B","#10B981","#022C22","#34D399"],theme:{primaryColor:"#34D399",primaryColorDark:"#10B981",pointerColor:"#F59E0B",bgDark:"#022C22",bgMid:"#064E3B",bgLight:"#0B3B2E"}},{id:"kraliyet-moru",name:"Kraliyet Moru",segments:["#7C3AED","#4C1D95","#2E1065","#8B5CF6","#1E1B4B","#A78BFA"],theme:{primaryColor:"#C084FC",primaryColorDark:"#A855F7",pointerColor:"#F472B6",bgDark:"#1E1B4B",bgMid:"#312E81",bgLight:"#0F0B2E"}},{id:"gun-batimi",name:"Gün Batımı",segments:["#F97316","#C2410C","#7C2D12","#EA580C","#9A3412","#FB923C"],theme:{primaryColor:"#FBBF24",primaryColorDark:"#F59E0B",pointerColor:"#EF4444",bgDark:"#431407",bgMid:"#7C2D12",bgLight:"#27150A"}}],P=[...new Set($.flatMap(h=>h.segments))],q="carkAdminConfig:";function F(h){return JSON.parse(JSON.stringify(h))}function M(h){if(!h)throw new Error("Mağaza kimliği olmadan admin önbelleği kullanılamaz");return`${q}${h}`}function _(h,e,t){try{const n=h.getItem(M(e));return n?JSON.parse(n):F(t)}catch{return F(t)}}function V(h,e,t){h.setItem(M(e),JSON.stringify(t))}function U(h,e={}){if(h){const t=String(h.type||"").toUpperCase();return{discountType:h.isFreeShipping===!0&&(!t||t==="FREE_SHIPPING")?"freeShipping":"ikasCampaign",discountValue:null}}return{discountType:e.discountType||"percentage",discountValue:Number.isFinite(e.discountValue)?e.discountValue:0}}function Y({discountType:h,discountValue:e}={}){return h==="freeShipping"?"Ücretsiz Kargo":h==="percentage"&&Number.isFinite(Number(e))?`%${Number(e)}`:h==="fixed"&&Number.isFinite(Number(e))?`${Number(e)} TL`:h==="ikasCampaign"?"İndirim değeri İkas kampanyası tarafından belirlenir":""}function T(h){return Number(h).toLocaleString("tr-TR",{maximumFractionDigits:2})}function W(h={}){var r,o,d,p,l;const e=String(h.type||"").toUpperCase(),t=Number((r=h.fixedDiscount)==null?void 0:r.amount),n=((o=h.tieredDiscount)==null?void 0:o.rules)||[],a=[];if(Number.isFinite(t)&&t>0)a.push(e==="RATIO"?`%${T(t)}`:`${T(t)} TL`);else if(n.length){const c=n.map(m=>Number(m.amount)).filter(m=>Number.isFinite(m)&&m>0);c.length&&a.push(`${T(Math.min(...c))}-${T(Math.max(...c))} TL kademeli`)}const i=Number((p=(d=h.fixedDiscount)==null?void 0:d.priceRange)==null?void 0:p.min);Number.isFinite(i)&&i>0&&a.push(`min. sepet ${T(i)} TL`);const s=Number((l=h.dateRange)==null?void 0:l.end);return Number.isFinite(s)&&a.push(`bitiş ${new Date(s).toLocaleDateString("tr-TR")}`),a.join(" • ")||"İndirim kuralı İkas tarafından belirlenir"}function D(h,e,t){const n=e||"https://BACKEND-URLINIZ";return`<!-- Çark Çevir Kazan Widget -->
...
<div class="ikas-guide">
  ...
  <ul>
...
</div>`}const O="cark-backend.onrender.com",K="https://ark-0ntz.onrender.com";window.location.hostname===O&&window.location.replace(`${K}${window.location.pathname}${window.location.search}${window.location.hash}`);function v(){return window.CARK_API_URL||(window.location.hostname===O?K:window.location.origin)}function b(){return localStorage.getItem("cark_admin_token")||sessionStorage.getItem("cark_admin_token")||""}function z(){localStorage.removeItem("cark_admin_token"),sessionStorage.removeItem("cark_admin_token")}function Q(h,e){z(),(e?localStorage:sessionStorage).setItem("cark_admin_token",h)}const Z={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function y(h){return String(h??"").replace(/[&<>"']/g,e=>Z[e])}class X{constructor(){this.config=JSON.parse(JSON.stringify(C)),this.store=null,this.currentTab="settings",this.editingSegmentId=null,this.authMode="login",this.isDirty=!1,this.init()}async init(){const e=new URLSearchParams(window.location.search),t=e.get("resetToken");if(t){this.showResetPasswordForm(t);return}const n=e.get("verifyToken");if(n){await this.verifyEmail(n);return}const a=b();if(a){const s=v();try{const r=await fetch(`${s}/api/auth/me`,{headers:{Authorization:`Bearer ${a}`}});if(r.ok){const o=await r.json();if(this.store=o.store,await this.loadFromBackend({render:!1}),!this.store.isOnboarded&&(!this.store.emailVerificationRequired||this.store.emailVerifiedAt)){this.showOnboarding();return}this.showContent();return}}catch{}z()}const i=new URLSearchParams(window.location.search).get("mode");this.showAuthForm(i==="register"?"register":"login")}isPro(){return this.store?this.store.planType==="pro"&&this.store.subscriptionStatus==="active"&&(!this.store.subscriptionEndsAt||new Date(this.store.subscriptionEndsAt)>new Date):!1}showContent(){var l,c,m,B;const e=document.getElementById("adminPasswordOverlay"),t=document.getElementById("adminContent");e&&(e.style.display="none"),t&&(t.style.display="block");const n=document.getElementById("adminStoreName");n&&this.store&&(n.textContent=this.store.name);const a=document.querySelector(".store-identity span");if(a&&this.store&&(a.textContent=this.isPro()?`Pro plan · ${this.store.subscriptionEndsAt?new Date(this.store.subscriptionEndsAt).toLocaleDateString("tr-TR"):"süresiz"}`:"Ücretsiz plan"),(l=document.getElementById("emailVerificationBanner"))==null||l.remove(),(c=this.store)!=null&&c.emailVerificationRequired&&!this.store.emailVerifiedAt){const E=document.createElement("div");E.id="emailVerificationBanner",E.className="email-verification-banner",E.innerHTML='<span><strong>E-postanızı doğrulayın.</strong> Ayar kaydetme, entegrasyon ve yayınlama doğrulama tamamlanana kadar kapalıdır.</span><button type="button" class="btn btn-secondary">E-postayı yeniden gönder</button>',(m=document.querySelector(".panel-main"))==null||m.prepend(E),E.querySelector("button").onclick=async()=>{const k=await fetch(`${v()}/api/auth/resend-verification`,{method:"POST",headers:{Authorization:`Bearer ${b()}`}}),g=await k.json().catch(()=>({}));this.showToast(k.ok?"Doğrulama e-postası gönderildi":g.error||"E-posta gönderilemedi",k.ok?"success":"error")}}const i=document.getElementById("storeAvatar");i&&this.store&&(i.textContent=this.store.name.trim().charAt(0).toLocaleUpperCase("tr-TR")||"M"),document.getElementById("panelYear").textContent=new Date().getFullYear();const s=document.getElementById("demoLink");s&&this.store&&(s.href="#panel-preview",s.onclick=E=>{var k;E.preventDefault(),this.currentTab!=="appearance"&&this.currentTab!=="settings"&&((k=document.querySelector('.admin-nav a[data-tab="appearance"]'))==null||k.click()),window.setTimeout(()=>{var u;const g=document.getElementById("appearancePreviewContainer")||document.getElementById("previewContainer");g==null||g.scrollIntoView({behavior:"smooth",block:"center"}),(u=g==null?void 0:g.closest(".admin-card"))==null||u.classList.add("preview-highlight"),window.setTimeout(()=>{var f;return(f=g==null?void 0:g.closest(".admin-card"))==null?void 0:f.classList.remove("preview-highlight")},1400)},80)}),(B=document.getElementById("logoutBtn"))==null||B.addEventListener("click",()=>this.logout());const r=document.getElementById("adminSidebar"),o=document.getElementById("sidebarToggle"),d=document.getElementById("sidebarScrim"),p=()=>{r==null||r.classList.remove("open"),d==null||d.classList.remove("show"),o==null||o.setAttribute("aria-expanded","false")};o==null||o.addEventListener("click",()=>{const E=!(r!=null&&r.classList.contains("open"));r==null||r.classList.toggle("open",E),d==null||d.classList.toggle("show",E),o.setAttribute("aria-expanded",String(E))}),d==null||d.addEventListener("click",p),this.setupSupportWidget(),this.setupTabs(),this.setupModalEscapeHandling(),this.render(),this._configLoadError&&this.showToast(`Backend ayarları alınamadı: ${this._configLoadError}`,"error")}setupSupportWidget(){const e=document.getElementById("supportWidget"),t=document.getElementById("supportTrigger"),n=document.getElementById("supportHeaderTrigger"),a=document.getElementById("supportPopover"),i=document.getElementById("supportClose"),s=document.getElementById("supportTicketForm");if(!e||!t||!a||t.dataset.ready==="true")return;t.dataset.ready="true";let r=t;const o=(d,p="floating")=>{d&&(r=p==="header"?n:t),a.hidden=!d,t.setAttribute("aria-expanded",String(d)),n==null||n.setAttribute("aria-expanded",String(d)),e.classList.toggle("open",d),e.classList.toggle("header-open",d&&p==="header"),d&&(i==null||i.focus())};t.addEventListener("click",()=>o(a.hidden)),n==null||n.addEventListener("click",()=>o(a.hidden,"header")),i==null||i.addEventListener("click",()=>{o(!1),r==null||r.focus()}),s==null||s.addEventListener("submit",async d=>{d.preventDefault();const p=s.querySelector("button"),l=document.getElementById("supportTicketStatus");p.disabled=!0,l.textContent="Gönderiliyor...";try{const c=await fetch(`${v()}/api/admin/tickets`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${b()}`},body:JSON.stringify({subject:document.getElementById("supportTicketSubject").value,message:document.getElementById("supportTicketMessage").value})}),m=await c.json().catch(()=>({}));if(!c.ok)throw new Error(m.error||"Destek talebi gönderilemedi");s.reset(),l.textContent="Talebiniz alındı."}catch(c){l.textContent=c.message}finally{p.disabled=!1}}),document.addEventListener("click",d=>{!a.hidden&&!e.contains(d.target)&&!(n!=null&&n.contains(d.target))&&o(!1)}),document.addEventListener("keydown",d=>{d.key==="Escape"&&!a.hidden&&(o(!1),r==null||r.focus())})}showAuthForm(e){this.authMode=e;const t=document.getElementById("adminPasswordOverlay");if(!t)return;t.style.display="grid",document.getElementById("authMainView").style.display="block",document.getElementById("forgotPasswordView").style.display="none",document.getElementById("resetPasswordView").style.display="none";const n=document.getElementById("authTitle"),a=document.getElementById("authSubtitle"),i=document.getElementById("authFieldStoreName"),s=document.getElementById("authStoreName"),r=document.getElementById("authEmail"),o=document.getElementById("authPassword"),d=document.getElementById("authFieldTerms"),p=document.getElementById("authTermsCheckbox"),l=document.getElementById("adminPasswordError");l.classList.remove("success");const c=document.getElementById("authSubmitBtn"),m=document.getElementById("authSwitchToRegisterWrap"),B=document.getElementById("authSwitchToLoginWrap"),E=document.getElementById("authLoginOptions"),k=e==="register";n.textContent=k?"Mağaza Oluştur":"Giriş Yap",a.textContent=k?"Kendi çark widget hesabınızı oluşturun":"Mağazanızın admin paneline giriş yapın",i.style.display=k?"block":"none",d.style.display=k?"block":"none",E.style.display=k?"none":"flex",k||(p.checked=!1),c.textContent=k?"Hesap Oluştur":"Giriş Yap",m.style.display=k?"none":"inline",B.style.display=k?"inline":"none",l.style.display="none",document.getElementById("authSwitchToRegister").onclick=f=>{f.preventDefault(),this.showAuthForm("register")},document.getElementById("authSwitchToLogin").onclick=f=>{f.preventDefault(),this.showAuthForm("login")};const g=f=>{l.style.display="block",l.textContent=f},u=async()=>{const f=v(),w=r.value.trim(),I=o.value,S=s.value.trim();if(!w||!I||k&&!S){g("Lütfen tüm alanları doldurun");return}if(k&&!p.checked){g("Devam etmek için sözleşmeleri onaylamalısınız");return}c.disabled=!0;try{const N=k?"/api/auth/register":"/api/auth/login",R=k?{storeName:S,email:w,password:I,termsAccepted:!0}:{email:w,password:I},x=await fetch(`${f}${N}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(R)}),L=await x.json().catch(()=>({}));if(!x.ok){g(L.error||"Bir hata oluştu");return}if(Q(L.token,k||document.getElementById("authRememberMe").checked),this.store=L.store,await this.loadFromBackend({render:!1}),!this.store.isOnboarded&&(!this.store.emailVerificationRequired||this.store.emailVerifiedAt)){this.showOnboarding();return}this.showContent()}catch{g("Backend bağlantı hatası")}finally{c.disabled=!1}};c.onclick=u,o.onkeydown=f=>{f.key==="Enter"&&u()},document.getElementById("authPasswordToggle").onclick=()=>this.togglePassword("authPassword","authPasswordToggle"),document.getElementById("authForgotPassword").onclick=f=>{f.preventDefault(),this.showForgotPasswordForm(r.value.trim())},(k?s:r).focus()}togglePassword(e,t){const n=document.getElementById(e),a=document.getElementById(t),i=n.type==="text";n.type=i?"password":"text",a.textContent=i?"Göster":"Gizle",a.setAttribute("aria-label",i?"Şifreyi göster":"Şifreyi gizle"),a.setAttribute("aria-pressed",String(!i)),n.focus()}showForgotPasswordForm(e=""){document.getElementById("adminPasswordOverlay").style.display="grid",document.getElementById("authMainView").style.display="none",document.getElementById("resetPasswordView").style.display="none";const t=document.getElementById("forgotPasswordView");t.style.display="block",document.getElementById("authTitle").textContent="Şifrenizi yenileyin",document.getElementById("authSubtitle").textContent="Güvenli bağlantıyı e-postanıza gönderelim.";const n=document.getElementById("forgotEmail"),a=document.getElementById("forgotPasswordError"),i=document.getElementById("forgotPasswordSuccess"),s=document.getElementById("forgotPasswordSubmit");n.value=e,a.style.display="none",i.style.display="none",s.onclick=async()=>{const r=n.value.trim();if(!r){a.textContent="E-posta adresinizi girin",a.style.display="block";return}s.disabled=!0,a.style.display="none",i.style.display="none";try{const o=await fetch(`${v()}/api/auth/forgot-password`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:r})}),d=await o.json().catch(()=>({}));if(!o.ok)throw new Error(d.error||"Bağlantı gönderilemedi");i.textContent=d.message,i.style.display="block"}catch(o){a.textContent=o.message,a.style.display="block"}finally{s.disabled=!1}},document.getElementById("forgotPasswordBack").onclick=()=>this.showAuthForm("login"),n.focus()}showResetPasswordForm(e){document.getElementById("adminPasswordOverlay").style.display="grid",document.getElementById("authMainView").style.display="none",document.getElementById("forgotPasswordView").style.display="none",document.getElementById("resetPasswordView").style.display="block",document.getElementById("authTitle").textContent="Yeni şifre belirleyin",document.getElementById("authSubtitle").textContent="Hesabınız için güçlü bir şifre oluşturun.";const t=document.getElementById("resetPassword"),n=document.getElementById("resetPasswordError"),a=document.getElementById("resetPasswordSuccess"),i=document.getElementById("resetPasswordSubmit");document.getElementById("resetPasswordToggle").onclick=()=>this.togglePassword("resetPassword","resetPasswordToggle"),i.onclick=async()=>{if(t.value.length<8){n.textContent="Şifre en az 8 karakter olmalıdır",n.style.display="block";return}i.disabled=!0,n.style.display="none";try{const s=await fetch(`${v()}/api/auth/reset-password`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,newPassword:t.value})}),r=await s.json().catch(()=>({}));if(!s.ok)throw new Error(r.error||"Şifre yenilenemedi");a.textContent="Şifreniz yenilendi. Artık giriş yapabilirsiniz.",a.style.display="block",i.style.display="none",history.replaceState({},"","/mystore/panel")}catch(s){n.textContent=s.message,n.style.display="block"}finally{i.disabled=!1}},document.getElementById("resetPasswordBack").onclick=()=>{history.replaceState({},"","/mystore/panel"),this.showAuthForm("login")},t.focus()}async verifyEmail(e){try{const t=await fetch(`${v()}/api/auth/verify-email`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw new Error(n.error||"E-posta doğrulanamadı");history.replaceState({},"","/mystore/panel"),this.showAuthForm("login");const a=document.getElementById("adminPasswordError");a.classList.add("success"),a.textContent="E-posta adresiniz doğrulandı. Giriş yapabilirsiniz.",a.style.display="block"}catch(t){history.replaceState({},"","/mystore/panel"),this.showAuthForm("login");const n=document.getElementById("adminPasswordError");n.classList.remove("success"),n.textContent=t.message,n.style.display="block"}}logout(){z(),this.store=null,this.config=JSON.parse(JSON.stringify(C)),document.getElementById("adminContent").style.display="none",this.showAuthForm("login")}async onboardingRequest(e,t,n={}){const a=await fetch(`${v()}${t}`,{method:e,headers:{"Content-Type":"application/json",Authorization:`Bearer ${b()}`},body:JSON.stringify(n)}),i=await a.json().catch(()=>({}));if(!a.ok)throw new Error(i.error||"İşlem tamamlanamadı");return i}showOnboarding(){var p;document.getElementById("adminPasswordOverlay").style.display="none",document.getElementById("adminContent").style.display="none";const e=document.getElementById("onboardingOverlay"),t=document.getElementById("onboardingError");e.classList.add("active"),(p=e.querySelector(".edit-modal"))==null||p.focus();const n=(l="")=>{t.textContent=l,t.style.display=l?"block":"none"},a=l=>{var c;for(let m=1;m<=3;m+=1)document.getElementById(`onboardingStep${m}`).style.display=m===l?"block":"none",(c=document.querySelector(`[data-onboarding-progress="${m}"]`))==null||c.classList.toggle("active",m<=l);n()},i=async(l,c)=>{l.disabled=!0,n();try{await c()}catch(m){n(m.message||"Backend bağlantı hatası")}finally{l.disabled=!1}};a(1);const s=document.getElementById("onboardingStep1Next");s.onclick=()=>i(s,async()=>{const l=document.getElementById("onboardingDomain").value.trim();if(!l)throw new Error("Lütfen mağazanızın domainini girin");await this.onboardingRequest("PUT","/api/admin/domains",{domains:[l]}),a(2)});const r=document.getElementById("onboardingPaletteOptions");r.innerHTML=$.map((l,c)=>`
      <label class="onboarding-palette-card">
        <input type="radio" name="onboardingPalette" value="${l.id}" ${c===0?"checked":""}>
                ...
                ${e.map((t,n)=>`
                  <div class="segment-item" data-id="${t.couponGroupId}">
                    ...
                    <div class="segment-info">
                      ...
                      <div class="segment-meta">Çarkta ${t.sliceCount} dilim • Kazanma ağırlığı: %${Number(t.probability.toFixed(1))} ${t.couponCode?`• Kod: ${y(t.couponCode)}`:""} ${t.ikasCampaignId?`• ${y(Y(t)||"İkas kampanyasına bağlı")}`:""}</div>
                    </div>
    ...
    `}async loadHistory(){const e=document.getElementById("historyContainer");if(!e)return;const t=v();if(!b()||!t){e.textContent="Sadece kayıtlı hesaplarda görünür.";return}try{const n=await fetch(`${t}/api/admin/history`,{headers:{Authorization:`Bearer ${b()}`}});if(!n.ok)throw new Error("failed");const{changes:a}=await n.json();if(!a.length){e.textContent="Henüz bir değişiklik kaydı yok.";return}e.innerHTML=a.map(i=>`
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <div class="segment-color-swatches" id="segColorSwatches">
            ${P.map(i=>`<button type="button" class="segment-color-swatch ${i.toUpperCase()===String(n.color).toUpperCase()?"active":""}" data-color="${i}" style="background:${i}" title="${i}"></button>`).join("")}
          </div>
          <div class="color-input-wrapper">
    ...
    `}setupEntriesListeners(){var n,a,i,s,r,o,d,p,l,c,m,B,E,k;this.entriesPage=this.entriesPage||1,this.entriesPageSize=this.entriesPageSize||25,this.entriesFilters=this.entriesFilters||{dateFrom:"",dateTo:"",prize:"",status:"",search:""},this.selectedEntryIds=new Set,this.loadEntries();const e=()=>{this.entriesFilters={dateFrom:document.getElementById("entriesDateFrom").value,dateTo:document.getElementById("entriesDateTo").value,prize:document.getElementById("entriesPrizeFilter").value,status:document.getElementById("entriesStatusFilter").value,search:document.getElementById("entriesSearch").value.trim()},this.entriesPage=1,this.selectedEntryIds.clear(),this.loadEntries()};["entriesDateFrom","entriesDateTo","entriesPrizeFilter","entriesStatusFilter"].forEach(g=>{var u;(u=document.getElementById(g))==null||u.addEventListener("change",e)});let t;(n=document.getElementById("entriesSearch"))==null||n.addEventListener("input",()=>{clearTimeout(t),t=setTimeout(e,350)}),(a=document.getElementById("resetEntriesFiltersBtn"))==null||a.addEventListener("click",()=>{this.entriesFilters={dateFrom:"",dateTo:"",prize:"",status:"",search:""},["entriesDateFrom","entriesDateTo","entriesPrizeFilter","entriesStatusFilter","entriesSearch"].forEach(g=>{const u=document.getElementById(g);u&&(u.value="")}),this.entriesPage=1,this.selectedEntryIds.clear(),this.loadEntries()}),(i=document.getElementById("exportBtn"))==null||i.addEventListener("click",()=>this.downloadEntries("csv")),(s=document.getElementById("exportExcelBtn"))==null||s.addEventListener("click",()=>this.downloadEntries("excel")),(r=document.getElementById("exportBrokenBtn"))==null||r.addEventListener("click",()=>this.downloadEntries("csv",{status:"failed"})),(o=document.getElementById("showBrokenBtn"))==null||o.addEventListener("click",()=>{var g;document.getElementById("entriesStatusFilter").value="failed",e(),(g=document.getElementById("entriesContainer"))==null||g.scrollIntoView({behavior:"smooth",block:"start"})}),(d=document.getElementById("retryBrokenBtn"))==null||d.addEventListener("click",()=>this.retryAllBrokenEntries()),(p=document.getElementById("clearEntriesBtn"))==null||p.addEventListener("click",async()=>{if(!confirm("Tüm katılımcı verileri silinecek. Emin misiniz?"))return;const g=v(),u=await fetch(`${g}/api/admin/entries`,{method:"DELETE",headers:{Authorization:`Bearer ${b()}`}}),f=await u.json().catch(()=>({}));if(!u.ok){this.showToast(f.error||"Katılımcılar silinemedi","error");return}this.entriesPage=1,this.loadEntries(),this.showToast("Veriler silindi")}),(l=document.getElementById("entriesBulkToolbar"))==null||l.addEventListener("click",g=>{var f;const u=(f=g.target.closest("[data-bulk-action]"))==null?void 0:f.dataset.bulkAction;u&&this.handleEntriesBulkAction(u)}),(c=document.getElementById("createTestEntryBtn"))==null||c.addEventListener("click",()=>this.createTestEntry()),(m=document.getElementById("checkWidgetStatusBtn"))==null||m.addEventListener("click",()=>this.checkWidgetStatus()),(B=document.getElementById("openInstallGuideBtn"))==null||B.addEventListener("click",()=>{var g;(g=document.querySelector('.admin-nav a[data-tab="integration"]'))==null||g.click()}),(E=document.getElementById("closeEntryDetailBtn"))==null||E.addEventListener("click",()=>this.closeEntryDetail()),(k=document.getElementById("entryDetailScrim"))==null||k.addEventListener("click",()=>this.closeEntryDetail())}async loadEntries(){var c,m,B,E,k,g;const e=document.getElementById("entriesContainer");if(!e)return;const t=v(),n=this.entriesPageSize||25;e.innerHTML='<div class="entries-loading-state"><div class="entries-spinner"></div><span>Katılımcılar yükleniyor...</span></div>';let a,i,s,r;if(b())try{const u=b(),f=this.entriesQueryParams();f.set("page",this.entriesPage||1),f.set("limit",n);const[w,I]=await Promise.all([fetch(`${t}/api/admin/entries?${f}`,{headers:{Authorization:`Bearer ${u}`}}),fetch(`${t}/api/admin/stats`,{headers:{Authorization:`Bearer ${u}`}})]);if(!w.ok||!I.ok)throw new Error("Katılımcılar yüklenemedi");const S=await w.json();a=S.entries||[],s=S.total||0,r=S.prizes||[],i=await I.json()}catch(u){e.innerHTML=`<div class="entries-error-state"><strong>Katılımcılar yüklenemedi</strong><span>${y(u.message)}</span><button class="btn btn-secondary" id="retryEntriesLoadBtn">Tekrar dene</button></div>`,(c=document.getElementById("retryEntriesLoadBtn"))==null||c.addEventListener("click",()=>this.loadEntries());return}else{e.innerHTML='<div class="entries-error-state"><strong>Oturum bulunamadı</strong><span>Katılımcı verilerini görmek için tekrar giriş yapın.</span></div>';return}this.currentEntries=a,this.currentEntryMap=new Map(a.map(u=>[String(u.id),u]));const o=document.getElementById("entriesPrizeFilter");if(o){const u=((m=this.entriesFilters)==null?void 0:m.prize)||"";o.innerHTML=`<option value="">Tüm ödüller</option>${r.map(f=>`<option value="${y(f)}">${y(f)}</option>`).join("")}`,o.value=u}document.getElementById("stat-total").textContent=i.total,document.getElementById("stat-today").textContent=i.today,document.getElementById("stat-mostwon").textContent=i.mostWon,document.getElementById("stat-processed").textContent=i.processed??0,document.getElementById("stat-broken").textContent=i.failed??i.brokenCoupons??0,document.getElementById("stat-conversion").textContent=`%${i.conversionRate??0}`;const d=i.failed??i.brokenCoupons??0,p=document.getElementById("entriesIssueBanner");if(p.hidden=d===0,document.getElementById("entriesIssueCount").textContent=d,this.renderPrizeDistribution(i.prizeDistribution||[]),b()?s===0:a.length===0){const u=Object.values(this.entriesFilters||{}).some(Boolean);e.innerHTML=u?'<div class="entries-empty-state"><div>🔎</div><strong>Filtrelere uygun katılımcı bulunamadı</strong><span>Filtreleri değiştirerek tekrar deneyin.</span><button class="btn btn-secondary" id="emptyResetFiltersBtn">Filtreleri temizle</button></div>':'<div class="entries-empty-state"><div>🎡</div><strong>Henüz katılımcı yok</strong><span>Çark sitenize eklendikten sonra katılımlar burada görünür.</span></div>',(B=document.getElementById("emptyResetFiltersBtn"))==null||B.addEventListener("click",()=>{var f;return(f=document.getElementById("resetEntriesFiltersBtn"))==null?void 0:f.click()});return}e.innerHTML=`
      <table class="entries-table">
        ...
        <tbody>
          ${a.map(u=>`
            <tr class="entry-row" data-entry-id="${y(u.id)}" tabindex="0">
              <td><input type="checkbox" class="entry-select" value="${y(u.id)}" ${this.selectedEntryIds.has(String(u.id))?"checked":""} aria-label="${y(u.name||"Katılımcı")} kaydını seç"></td>
              <td>${u.timestamp?new Date(u.timestamp).toLocaleString("tr-TR"):"-"}</td>
              <td>${y(u.name)||"-"}</td>
              <td><span class="masked-value" data-field="phone">${y(this.maskPhone(u.phone))||"-"}</span>${u.phone?'<button class="reveal-entry-value" data-field="phone" title="Telefonu göster">Göster</button>':""}</td>
              <td><span class="masked-value" data-field="email">${y(this.maskEmail(u.email))||"-"}</span>${u.email?'<button class="reveal-entry-value" data-field="email" title="E-postayı göster">Göster</button>':""}</td>
              <td class="entry-prize-cell">${y(u.prize)||"-"}</td>
              <td>${u.couponCode?`<code>${y(u.couponCode)}</code>`:"-"}</td>
              <td>${this.renderEntryStatus(u)}</td>
    ...
    `}setupBillingListeners(){var e,t;this.loadBillingHistory(),this.loadBillingStatus(),(e=document.getElementById("upgradeToProBtn"))==null||e.addEventListener("click",async n=>{const a=n.currentTarget;a.disabled=!0,a.textContent="Talep gönderiliyor...";try{const i=await fetch(`${v()}/api/admin/purchase-requests`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${b()}`},body:JSON.stringify({planType:"pro",note:"Panel üzerinden Pro plan talebi"})}),s=await i.json().catch(()=>({}));if(!i.ok)throw new Error(s.error||"Satın alma talebi gönderilemedi");this.showToast(s.message||"Talebiniz alındı"),a.textContent="Talep Alındı"}catch(i){this.showToast(i.message,"error"),a.disabled=!1,a.textContent="Pro'ya Yükselt"}}),(t=document.getElementById("cancelSubscriptionBtn"))==null||t.addEventListener("click",async n=>{if(!confirm("Aboneliğiniz iptal edilsin mi? Mevcut dönem sonuna kadar yüksek katılım kotanızı kullanmaya devam edersiniz."))return;const a=n.currentTarget;a.disabled=!0;try{if(!(await fetch(`${v()}/api/billing/cancel`,{method:"POST",headers:{Authorization:`Bearer ${b()}`}})).ok)throw new Error("İptal işlemi başarısız oldu");this.showToast("Abonelik iptal edildi");const s=await fetch(`${v()}/api/auth/me`,{headers:{Authorization:`Bearer ${b()}`}}),r=await s.json().catch(()=>({}));s.ok&&(this.store=r.store),this.render()}catch(i){this.showToast(i.message,"error"),a.disabled=!1}})}async loadBillingStatus(){const e=document.getElementById("billingQuotaStatus");if(e)try{const t=await fetch(`${v()}/api/billing/status`,{headers:{Authorization:`Bearer ${b()}`}}),n=await t.json().catch(()=>({}));if(!t.ok)throw new Error(n.error||"Kullanım bilgisi alınamadı");e.textContent=`Bu ay ${Number(n.monthlyUsage||0).toLocaleString("tr-TR")} / ${Number(n.monthlyLimit||0).toLocaleString("tr-TR")} katılım kullanıldı.`}catch(t){e.textContent=t.message}}async loadBillingHistory(){const e=document.getElementById("billingHistoryList");try{const t=await fetch(`${v()}/api/billing/history`,{headers:{Authorization:`Bearer ${b()}`}}),n=await t.json().catch(()=>({}));if(!t.ok)throw new Error(n.error||"Ödeme geçmişi alınamadı");const a=n.history||[];if(!a.length){e.textContent="Henüz bir ödeme kaydı yok.";return}e.innerHTML=`
